...
func (ec *executionContext) _LogoutResponse_errors(ctx context.Context, field graphql.CollectedField, obj *model.LogoutResponse) (ret graphql.Marshaler) {
...
func (ec *executionContext) _Mutation_register(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNAuthPayload2ᚖhoraᚑserverᚋgraphᚋmodelᚐAuthPayload(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Mutation_logout(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNLogoutResponse2ᚖhoraᚑserverᚋgraphᚋmodelᚐLogoutResponse(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalInputRegisterRequest(ctx context.Context, obj any) (model.RegisterRequest, error) {
	...
	fieldsInOrder := [...]string{"username", "email", "password", "name"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) marshalNAuthPayload2horaᚑserverᚋgraphᚋmodelᚐAuthPayload(ctx context.Context, sel ast.SelectionSet, v model.AuthPayload) graphql.Marshaler {
	return ec._AuthPayload(ctx, sel, &v)
}

func (ec *executionContext) marshalNAuthPayload2ᚖhoraᚑserverᚋgraphᚋmodelᚐAuthPayload(ctx context.Context, sel ast.SelectionSet, v *model.AuthPayload) graphql.Marshaler {
	if v == nil {
...
func (ec *executionContext) marshalNLogoutResponse2horaᚑserverᚋgraphᚋmodelᚐLogoutResponse(ctx context.Context, sel ast.SelectionSet, v model.LogoutResponse) graphql.Marshaler {
	return ec._LogoutResponse(ctx, sel, &v)
}

func (ec *executionContext) marshalNLogoutResponse2ᚖhoraᚑserverᚋgraphᚋmodelᚐLogoutResponse(ctx context.Context, sel ast.SelectionSet, v *model.LogoutResponse) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
